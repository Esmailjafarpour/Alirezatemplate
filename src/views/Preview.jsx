...
import rtl from "../assets/img/intro/alirezajafari.jpg";
...
const previewDemo = [
  ...
  {
    img: rtl,
    title: "Get to know Alireza Jafari more",
    routerPath: "/home-rtl",
    delayAnimation: "",
  },
];
    ...
    <div>
      <section className="banner text-center">
        <div className="content">
          <h1>Seyed Alireza Jafari</h1>
          <h2>Data-Driven Digital Marketing Manager (SaaS)</h2>
